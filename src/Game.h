    ...
    class Game{
      ...
      public:
        struct Settings{
            ...
            Color flagBackgroundColor = BLACK_BG;
            Color unrevealedColor = WHITE_FG;
            Color frameColor = WHITE_FG;
            Color frameBackgroundColor = BLACK_BG;
            Color numberColors[8] = {BLUE_FG, GREEN_FG, RED_FG, MAGENTA_FG, CYAN_FG, YELLOW_FG, WHITE_FG, WHITE_FG};
            Color numberBackgroundColor = BLACK_BG;
            Color mineColor = RED_FG;
            Color mineBackgroundColor = BLACK_BG;
